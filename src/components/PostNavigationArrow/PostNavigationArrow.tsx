...
const PostNavigationArrow: React.FC<PostNavigationArrowProps> = ({ direction, postId }) => {
    ...
    const divStyle = direction === 'previous' ? { top: 'calc(50% - 42px)', left: '0px' } : { top: 'calc(50% - 42px)', right: '0px' };
    const classNames = ['post-navigation-arrow', postId !== -1 ? 'active' : 'disabled', direction];
